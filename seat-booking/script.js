...
const seatTypes = [
  { type: 'Economy', description: 'Standard seating  reasonable comfort.', price: 300 },
  { type: 'Business', description: 'Premium seating  extra legroom and amenities.', price: 600 },
  { type: 'VIP', description: 'Luxury seating  spacious cabins and personalized service.', price: 1000 },
...
function showSeatDescription(seat, seatNumber) {
  ...
  const description = `Seat Type-${seatType.type} and \nPrice: ₹${seatType.price}`;
